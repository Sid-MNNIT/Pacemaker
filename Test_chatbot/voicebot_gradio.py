from doctor_Brain import encode_img, analyze_img
from patient_Voice import record_audio, transcribe_groq
...
def process_inputs(audio_filepath,image_filepath):
    ...
    speech_to_text_output = transcribe_groq(GROQ_API_KEY=os.environ.get("GROQ_API_KEY"), 
